...
public class ScStartAnno extends JFrame {
	...
	public ScStartAnno(Rectangle r, final boolean multiple) {
		...
		setBounds((int) r.getX(), (int) r.getY(), 500, 444);
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					while (sc.hasNext()) {
						...
						// perform variation annotations according to the chosen protocols.
		...
		btnSave.setBounds(17, 382, 117, 29);
		...
		btnClear.setBounds(188, 382, 117, 29);
		...
		btnCancel.setBounds(366, 382, 117, 29);
	...
	public void setProtocol() {
		...
		if (chk1000g.isSelected()){
			...
			protocol = protocol + "1000g2015aug_all,1000g2015aug_afr,1000g2015aug_amr,1000g2015aug_eas,1000g2015aug_eur,1000g2015aug_sas,";
...
perl annotate_variation.pl -downdb -webfrom annovar refGene --buildver hg19 humandb/
perl annotate_variation.pl -downdb -webfrom annovar knownGene --buildver hg19 humandb/
perl annotate_variation.pl -downdb -webfrom annovar ensGene --buildver hg19 humandb/
perl annotate_variation.pl -downdb -webfrom annovar cosmic70 --buildver hg19 humandb/
perl annotate_variation.pl -downdb -webfrom annovar snp129 --buildver hg19 humandb/
perl annotate_variation.pl -downdb -webfrom annovar snp131 --buildver hg19 humandb/
perl annotate_variation.pl -downdb -webfrom annovar snp135 --buildver hg19 humandb/
perl annotate_variation.pl -downdb -webfrom annovar dbnsfp30a --buildver hg19 humandb/
perl annotate_variation.pl -downdb -webfrom annovar dbnsfp31a_interpro --buildver hg19 humandb/
perl annotate_variation.pl -downdb -webfrom annovar dbscsnv11 --buildver hg19 humandb/
perl annotate_variation.pl -downdb -webfrom annovar exac03 --buildver hg19 humandb/
perl annotate_variation.pl -downdb -webfrom annovar 1000g2015aug --buildver hg19 humandb/
perl annotate_variation.pl -downdb -webfrom annovar clinvar_20160302 --buildver hg19 humandb/
perl annotate_variation.pl -downdb -webfrom annovar snp138 --buildver hg19 humandb/
perl annotate_variation.pl -downdb -webfrom annovar avsnp142 --buildver hg19 humandb/
perl annotate_variation.pl -downdb -webfrom annovar avsnp147 --buildver hg19 humandb/

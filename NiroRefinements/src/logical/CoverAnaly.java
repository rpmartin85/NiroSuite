...
public class CoverAnaly {
	...
	public CoverAnaly(String contig_id, long contig_srt, long contig_end, String region_id, String attributes, int gc,
			int overlaps, int fwd_e2e, int rev_e2e, int total_reads, int fwd_reads, int rev_reads, char flagColour) {
		super();

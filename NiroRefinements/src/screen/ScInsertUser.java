...
public class ScInsertUser extends JFrame {
	...
	public ScInsertUser(Rectangle r) {
		...
		int codeTemp = StartScreen.getConn().getMaxCod("USER", "cod_user");
	...
	public void setScEditProject(ScEditProject scEP){
		this.scEP = scEP;
	}
	
	public ScEditProject getScEP(){
		return scEP;
	}

...
public class ScInsertFamily extends JFrame {
	 ...
	 * Create the frame.
	 */
	public ScInsertFamily(Rectangle r) {

		scIPat = null;
		scEPat = null;

		setResizable(false);
		setTitle("Insert New Family");
		...
		int codeTemp = StartScreen.getConn().getMaxCod("FAMILY", "cod_family");
